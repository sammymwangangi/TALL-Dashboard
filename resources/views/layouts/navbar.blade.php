<nav x-data="{ open: true }" class="sticky top-0 shadow-lg bg-white shadow">
...
{{--            </div>--}}
{{--            @else--}}
            <button class="p-1 border-2 border-transparent text-gray-400 rounded-full hover:text-gray-100 hover:bg-gray-300 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">
                <svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
