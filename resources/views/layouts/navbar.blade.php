<nav x-data="{ open: true }" class="sticky top-0 shadow-lg bg-green-100 shadow">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div class="hidden sm:block sm:ml-6">
                <div class="leading-5 relative mt-3 md:mt-0" x-data="{ isOpen: true }" @click.away="isOpen = false">
                    <input
                        type="text"
                        class="bg-indigo-100 text-sm rounded w-64 px-4 pl-8 py-2 focus:outline-none focus:shadow-outline" placeholder="Search for..."
                        x-ref="search"
                    >
