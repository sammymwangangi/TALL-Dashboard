<div class="h-auto bg-gradient-to-r from-yellow-500 via-pink-500 to-purple-500 mb-6">
    <div class="px-6 py-6 md:grid md:grid-cols-4 gap-4">
...
{{--            <p class="text-3xl font-bold text-gray-600">{{ $repository['stargazers_count'] }}</p>--}}
            <p class="text-3xl font-bold text-gray-600">10000</p>
...
{{--            <p class="text-3xl font-bold text-gray-600">{{ $repository['subscribers_count'] }}</p>--}}
            <p class="text-3xl font-bold text-gray-600">4000</p>
...
{{--            <p class="text-3xl font-bold text-gray-600">{{ $repository['forks_count'] }}</p>--}}
            <p class="text-3xl font-bold text-gray-600">500</p>
...
{{--            <p class="text-3xl font-bold text-gray-600">{{ ($contributor['0']['contributions']) + ($contributor['1']['contributions']) }}</p>--}}
