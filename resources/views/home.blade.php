...
@section('content')
    <div class="h-full flex lg:overflow-y-hidden">
      <div x-data="{ open: true }" class="min-h-full w-1/5 bg-white flex-none flex flex-col">
         <div class="px-4 py-6 flex">
             <img class="h-10 w-10 rounded-full" src="/images/cabin2.svg" alt="" />
             <h1 class="ml-2 text-green-400 font-bold text-2xl py-1 hidden md:block lg:block">TALL Dashboard</h1>
         </div>

          <div class="hidden font-semibold text-center md:block lg:block px-4 py-3">
              <div class="bg-green-400 text-white px-2 py-2 flex rounded mb-2">
              ...
              <div class="text-gray-400 text-left text-base leading-tight px-2 py-2 mb-2">
                  APPS
              </div>

              <div class="hover:bg-green-400 text-gray-600 text-sm hover:text-white px-2 py-2 flex rounded mb-2">
          ...
          <div class="fixed bottom-0 flex-shrink px-4 w-1/5 bg-gray-100 py-3">
              <div class="lg:flex">
                  <img class="h-10 w-10 rounded-lg shadow-xl hover:shadow-orange-xl" src="/images/rix.jpg" alt="" />
                  <div class="flex-none flex flex-col lg:px-4 text-gray-600">
      ...
      <div class="flex-1 min-h-full w-4/5 lg:overflow-y-auto bg-gray-100">
