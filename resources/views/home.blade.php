...
@section('content')
    <div class="h-full flex lg:overflow-y-hidden">
      <div x-data="{ open: true }" class="min-h-full w-1/5 bg-green-400 flex-none flex flex-col">
         <div class="bg-green-500 px-4 py-3 flex">
          ...
          <div class="hidden font-semibold text-center md:block lg:block px-4 py-3 text-sm">
          ...
          <div class="fixed bottom-0 flex-shrink px-4 py-3">
              <div class="lg:flex">
                  <img class="h-10 w-10 rounded-lg shadow-xl hover:shadow-orange-xl" src="/images/rix.jpg" alt="" />
                  <div class="flex-none flex flex-col lg:px-4">
      ...
      <div class="flex-1 min-h-full w-4/5 bg-white lg:overflow-y-auto">
